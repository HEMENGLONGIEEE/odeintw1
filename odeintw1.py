...
def odeintw(func, y0, t, my_arg, t_arg=[0], **kwargs):
    """
    ...
    result = odeint(func2, y0.view(np.float64), t, args=(my_arg,), Dfun=jacfunc2, tcrit=t_arg, **kwargs)
    ...
    if full_output:
        ...
        result = sol
    return result# Copyright (c) 2014, Warren Weckesser
# All rights reserved.
# See the LICENSE file for license information.
